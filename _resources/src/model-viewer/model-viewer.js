...
AFRAME.registerComponent('model-viewer', {
  ...
  initCameraRig: function () {
    ...
    if (!this.el.sceneEl.is('vr-mode')) {
      console.log("not VR");
      cameraEl.setAttribute('position', "0 0 -1.8");
    }
  ...
  initEntities: function () {
    ...
    document.addEventListener('keydown', function(event) {
      var code = event.key;
      console.log("howdy", code);
      switch (code) {
        case "ArrowRight":
          modelEl.object3D.rotation.y += .1;
          break;
        case "ArrowUp":
          modelEl.object3D.rotation.x += .1;
          break;
        case "ArrowLeft":
          modelEl.object3D.rotation.y -= .1;
          break;
    ...
    modelEl.setAttribute('rotation', '0 -40 0');
  ...
  onExitVR: function () {
    ...
    this.cameraEl.setAttribute('position', "0 0 -1.5");
